      ...
      in
      {
        devShells.default = pkgs.mkShell {
          buildInputs = with pkgs; [
            ...
            # hugo renders the site; the reference under docs/content is
            # generated by tools/gendocs, which needs no tool of its own.
            # mkdocs and pandoc left with Docs.Html and Docs.Man.
            hugo
          ...
          shellHook = ''
            ...
            echo "  mage docs:build     - Render the documentation site"
            echo "  mage docs:serve     - Serve it with live reload"
            echo ""
