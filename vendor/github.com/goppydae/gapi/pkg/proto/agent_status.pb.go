...
// 	protoc        (unknown)
// source: gapi/v1/agent_status.proto
...
func (AgentState) Descriptor() protoreflect.EnumDescriptor {
	return file_gapi_v1_agent_status_proto_enumTypes[0].Descriptor()
}

func (AgentState) Type() protoreflect.EnumType {
	return &file_gapi_v1_agent_status_proto_enumTypes[0]
}
...
func (AgentState) EnumDescriptor() ([]byte, []int) {
	return file_gapi_v1_agent_status_proto_rawDescGZIP(), []int{0}
}
...
func (x *AgentStatus) Reset() {
	*x = AgentStatus{}
	mi := &file_gapi_v1_agent_status_proto_msgTypes[0]
...
func (x *AgentStatusRequest) Reset() {
	*x = AgentStatusRequest{}
	mi := &file_gapi_v1_agent_status_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AgentStatusRequest) Descriptor() ([]byte, []int) {
	return file_gapi_v1_agent_status_proto_rawDescGZIP(), []int{1}
}
...
func (x *AgentStatusResponse) Reset() {
	*x = AgentStatusResponse{}
	mi := &file_gapi_v1_agent_status_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AgentStatusResponse) Descriptor() ([]byte, []int) {
	return file_gapi_v1_agent_status_proto_rawDescGZIP(), []int{2}
}
...
const file_gapi_v1_agent_status_proto_rawDesc = "" +
	"\n" +
	"\x1agapi/v1/agent_status.proto\x12\agapi.v1\"\xcb\x02\n" +
	"\vAgentStatus\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12)\n" +
	"\x05state\x18\x03 \x01(\x0e2\x13.gapi.v1.AgentStateR\x05state\x12\x12\n" +
	...
	"\x12AgentStatusRequest\"C\n" +
	"\x13AgentStatusResponse\x12,\n" +
	"\x06agents\x18\x01 \x03(\v2\x14.gapi.v1.AgentStatusR\x06agents*\x96\x02\n" +
	"\n" +
	"AgentState\x12\x1b\n" +
	...
	"\x15AGENT_STATE_RELOADING\x10\tB+Z)github.com/goppydae/gapi/pkg/proto;gapiv1b\x06proto3"

var (
	file_gapi_v1_agent_status_proto_rawDescOnce sync.Once
	file_gapi_v1_agent_status_proto_rawDescData []byte
)

func file_gapi_v1_agent_status_proto_rawDescGZIP() []byte {
	file_gapi_v1_agent_status_proto_rawDescOnce.Do(func() {
		file_gapi_v1_agent_status_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_gapi_v1_agent_status_proto_rawDesc), len(file_gapi_v1_agent_status_proto_rawDesc)))
	})
	return file_gapi_v1_agent_status_proto_rawDescData
}

var file_gapi_v1_agent_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_gapi_v1_agent_status_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_gapi_v1_agent_status_proto_goTypes = []any{
	(AgentState)(0),             // 0: gapi.v1.AgentState
	(*AgentStatus)(nil),         // 1: gapi.v1.AgentStatus
	(*AgentStatusRequest)(nil),  // 2: gapi.v1.AgentStatusRequest
	(*AgentStatusResponse)(nil), // 3: gapi.v1.AgentStatusResponse
}
var file_gapi_v1_agent_status_proto_depIdxs = []int32{
	0, // 0: gapi.v1.AgentStatus.state:type_name -> gapi.v1.AgentState
	1, // 1: gapi.v1.AgentStatusResponse.agents:type_name -> gapi.v1.AgentStatus
...
func init() { file_gapi_v1_agent_status_proto_init() }
func file_gapi_v1_agent_status_proto_init() {
	if File_gapi_v1_agent_status_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gapi_v1_agent_status_proto_rawDesc), len(file_gapi_v1_agent_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gapi_v1_agent_status_proto_goTypes,
		DependencyIndexes: file_gapi_v1_agent_status_proto_depIdxs,
		EnumInfos:         file_gapi_v1_agent_status_proto_enumTypes,
		MessageInfos:      file_gapi_v1_agent_status_proto_msgTypes,
	}.Build()
	File_gapi_v1_agent_status_proto = out.File
	file_gapi_v1_agent_status_proto_goTypes = nil
	file_gapi_v1_agent_status_proto_depIdxs = nil
}
