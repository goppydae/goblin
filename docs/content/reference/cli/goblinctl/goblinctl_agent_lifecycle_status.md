---
title: "goblinctl agent lifecycle status"
---

## goblinctl agent lifecycle status

Query lifecycle state of one or more agents

```
goblinctl agent lifecycle status AGENT... [flags]
```
