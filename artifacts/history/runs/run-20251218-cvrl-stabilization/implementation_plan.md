...
#### [MODIFY] [tools/](file:///home/sysop/Projects/silo/gapi/tools/)
- Sync all scripts and linters from `goppydae-silo/tools/`.
- Standardize all paths to `artifacts/`.

#### [MODIFY] [AGENTS.md](file:///home/sysop/Projects/silo/gapi/AGENTS.md)
- Update with stabilized CVRL definitions.

#### [NEW] [agenda_state.json](file:///home/sysop/Projects/silo/gapi/artifacts/history/agenda_state.json)
...
#### [MODIFY] [tools/](file:///home/sysop/Projects/silo/goblin/tools/)
- Sync all scripts and linters from `goppydae-silo/tools/`.
- Standardize all paths to `artifacts/`.

#### [MODIFY] [AGENTS.md](file:///home/sysop/Projects/silo/goblin/AGENTS.md)
- Update with stabilized CVRL definitions.

#### [NEW] [agenda_state.json](file:///home/sysop/Projects/silo/goblin/artifacts/history/agenda_state.json)
- Initialize/Standardize the agenda state to satisfy `history_lint`.
